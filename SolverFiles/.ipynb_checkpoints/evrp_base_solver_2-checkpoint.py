...
for instance in run_instances:
    ...
    solution_path = Path("./Solution/base/small_instances/Cplex5er")
    ...
    # Penalty parameters
    penalty_for_overcharging = 0
    penalty_for_overdischarging = 0
    # When to penalise for overcharging or overdischarging
    overcharge_level_for_penalty = 0
    overdischarge_level_for_penalty = 1
